...
static const Rule rules[] = {
    ...
    {"solvespace", "Solvespace", "SolveSpace - Property Browser", 0, 1, -1},
};
...
static const char *dmenucmd[] = { "/usr/bin/rofi", "-show", "run", NULL };
static const char *passcmd[] = { "/usr/bin/passmenu", NULL };
